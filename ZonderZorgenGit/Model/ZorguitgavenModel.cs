...
namespace ZonderZorgenGit.Model
{
    class ZorguitgavenModel
    {
        ...
        public List<string>[] GetZiekenhuisKosten()
        {
            string query = "SELECT totaal_financieringsbronnen_2015, totaal_financieringsbronnen_2016 FROM zorguitgaven WHERE onderwerp = 'ziekenhuizen_en_specialistenpraktijken'";
        ...
        public List<string>[] GetOndersteunendKosten()
        {
            string query = "SELECT totaal_financieringsbronnen_2015, totaal_financieringsbronnen_2016 FROM zorguitgaven WHERE onderwerp = 'ondersteunende_diensten'";
        ...
        public List<string>[] GetTotaalKosten()
        {
            string query = "SELECT totaal_financieringsbronnen_2015, totaal_financieringsbronnen_2016 FROM zorguitgaven WHERE onderwerp = 'totaal_zorguitgaven,_incl._welzijn'";
